...
//         onBlockModelUpload(dataWithoutHeaders);
...
//           className="mt-2 bg-blue-500 text-white px-4 py-2 rounded disabled:bg-blue-300"
//         >
//           Process Block Model
//         </button>
//       </div>
      
//       {isLoading && <p className="text-blue-500">Processing file...</p>}
